  ...
  private func configureButton() {
    ...
    NSLayoutConstraint.activate([
      ...
      button.leadingAnchor.constraint(
        greaterThanOrEqualTo: view.leadingAnchor, constant: Spacing.medium),
      view.trailingAnchor.constraint(
        greaterThanOrEqualTo: button.trailingAnchor, constant: Spacing.medium),
      view.bottomAnchor.constraint(
        greaterThanOrEqualTo: button.bottomAnchor, constant: Spacing.medium),
    ])
  }
}
...
extension FirstViewButton: Styleable {
  ...
  func apply(style: UIButtonStyle) {
    contentEdgeInsets = UIEdgeInsets(
      top: Spacing.small, left: Spacing.small, bottom: Spacing.small, right: Spacing.small)
