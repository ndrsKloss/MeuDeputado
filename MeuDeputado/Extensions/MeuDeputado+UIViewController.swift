...
extension LoaderAndErrorPresentable where Self: UIViewController {
  func configureLoaderView() -> LoaderView {
    ...
    NSLayoutConstraint.activate([
      ...
      loaderView.topAnchor.constraint(
        greaterThanOrEqualToSystemSpacingBelow: guide.topAnchor, multiplier: 1.0),
      ...
      guide.bottomAnchor.constraint(
        greaterThanOrEqualToSystemSpacingBelow: loaderView.bottomAnchor, multiplier: 1.0),
    ])
...
extension LoaderAndErrorPresentable where Self: UIViewController {
  func configureErrorView() -> ErrorView {
    ...
    NSLayoutConstraint.activate([
      ...
      guide.bottomAnchor.constraint(
        greaterThanOrEqualToSystemSpacingBelow: errorView.bottomAnchor, multiplier: 1.0),
    ])
