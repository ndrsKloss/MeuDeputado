...
final class LoaderView: UIView {
  ...
  private func configureActivitiIndicatorView() {
    ...
    NSLayoutConstraint.activate([
      ...
      activitiIndicatorView.leadingAnchor.constraint(
        equalTo: leadingAnchor, constant: Spacing.large),
      trailingAnchor.constraint(
        equalTo: activitiIndicatorView.trailingAnchor, constant: Spacing.large),
